"""B1 — The agentic reference architecture, and every risk it carries.

One vendor-neutral architecture (B1.1), then fifteen risks, one per lesson,
mapped to the OWASP Agentic Security Initiative threat taxonomy. Every risk
names the component of B1.1 that it attacks, and every lesson carries exactly
one block of code: the risk, realised.

The controls are Chapters B2 and B3. Nothing here is fixed in this chapter, on
...
# B1.1 is the drawing lesson, and for a long time it was the only one that ran
