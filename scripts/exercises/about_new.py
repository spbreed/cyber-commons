...
"E3.10": "The corpus is CyberTravels' agent runs — the Workflow Agent and the "
...
"E2.5": "The incident is CyberTravels': the Workflow Agent issued a refund "
...
"E3.2": "The admission set is written for CyberTravels' agent-misuse class: "
...
"E3.6": "The investigation is CyberTravels' refund incident, and the branch "
        ...
        "server's tool description, which is B1.13's risk arriving as an "
        "incident.",

"E4.1": "The nine actions are CyberTravels' actual response levers, from "
...
"E4.2": "The incident is CyberTravels' runaway Workflow Agent, and the "
        "numbers are its containment ladder from B3.9 timed three ways. "
...
"E5.2": "The control chain is CyberTravels': provenance at ingress (B2.6), "
        "default-deny on the tool call (B3.1), the detection that should have "
...
"E5.4": "The six indicators are CyberTravels' own, and two of them do not "
...
"E5.5": "The diff is against CyberTravels' policy, and the expensive line is "
...
"F1.13": "The indicators are computed from the CyberTravels repository itself "
         "— the same tree C2.3 scans and B1.1 draws. Five of six report gaps, "
         ...
         "zero until B3.7's gateway exists. That is the backlog in the same "
