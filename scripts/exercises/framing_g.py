...
""",
 "G2.4": """
   ...
   ingress          ─►  prompt injection            A1.2
   vendor MCP       ─►  indirect injection          A1.3
   tool description ─►  rug-pull after approval     A1.9
   memory           ─►  persistence                 A1.4
   a2a              ─►  one becomes four            A1.7
   the human gate   ─►  saturation                  A3.9
""",
}

# The chapter bridge — what the reader gained, what they still cannot do, and
# which lesson answers it. G2's bridge is the handover into Function A and is
...
BRIDGES: dict[str, dict] = {
 "G1": {
   ...
   "next": "G2.0 — why a demo is not a system, and the three things that "
           "separate them.",
 },
 "G2": {
   ...
   "gap": "Everything you have measured, you measured against what you "
          ...
          "side, a way in.",
   "next": "A1.0 — the same architecture, read adversarially, and the zero-trust "
