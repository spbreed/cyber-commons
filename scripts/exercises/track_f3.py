"""F3 — The BISO, Risk Communicator & CISO Office. Eight sessions.

The last track. Everything built in A through F1/F2 becomes a decision someone
senior has to make, and the job is to make it makeable.
    ...
    F3.5  the metrics that matter at this level
...
("md", "## 4 · The control — four roles, and which to hire first"),
  ("html", D.table(
    ...
    [["identity engineer", "B2", "agent identity and delegation",
      "revocation · attribution · act chains", "<b>3</b>"],
     ["detection engineer", "E1", "agent telemetry and drift",
      "drift alerts · agent detections", "2"],
     ["GRC practitioner", "F1", "tiering, evidence, continuous verification",
      "inventory · control coverage", "2"],
     ["harness engineer", "C2", "the loop, the verifier, the eval",
