...
Three things change when the actor is an agent, and each has a lesson here:
    ...
    E5.3  the post-incident change surface
    E5.6  the regulatory clock

As with `track_e1.py`, the file name is historical and the lessons span four
...
("html", D.table(
    ...
    [["1. disable the user account",
      "1. identify the <b>acting</b> identity from the act chain (B2.5)"],
     ["2. interview the user",
      "2. revoke that identity — no approval needed for a non-human (B3.6)"],
     ["3. review the user's recent activity",
      "3. scope by walking the delegation chain, not the host list (E3.7)"],
     ["", "4. preserve the run trace before anything restarts (E5.1)"],
...
""",
 "steps": [
  ...
  ("html", D.table(
    ...
    emphasise=1,
    caption="The same surfaces E1.2 watches for drift. There they were the "
...
("md", "## 4 · The control — run the game day and record the number"),
 ...
 "challenge": "Run the game day. The deliverable is the number, and the number is "
              "what goes in the evidence pack for F1.7 and the board slide for "
              "F3.5. An untested stop button is a belief.",
},
