"""F2 — The Regulatory & Compliance Lead. Nine sessions.

    F2.1  the regulatory map — three layers, and which one bites first
    F2.2  horizontal AI regulation as controls, not clauses
    F2.3  voluntary frameworks as the spine
    F2.4  sector overlays, which already applied
    F2.5  privacy: the context window is a disclosure
