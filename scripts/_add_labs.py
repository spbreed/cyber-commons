...
NEW = {
 ...
 # ---------------- D1 SOC ----------------
 "D3.3": {"goal": "Show a context-loaded triage loop beating a generic one.",
  "run": ["cd labs/d1-soc",
 ...
 "D2.3": {"goal": "Generate, unit-test and tune detections inside CI.",
 ...
 "D1.1": {"goal": "Get agent telemetry into the SIEM and query it.",
  "run": ["cd labs/d1-soc",
 ...
 "D1.4": {"goal": "Catch a detection silently degrading after a model change.",
  "run": ["cd labs/d1-soc",
 ...
 "D1.3": {"goal": "Build a synthesis loop that must cite or abstain.",
 ...
 "D3.7": {"goal": "Scope an incident where the initiating agent is not the acting one.",
  "run": ["cd labs/d2-ir",
 ...
 "D5.3": {"goal": "Pick the right layer to change after an incident.",
