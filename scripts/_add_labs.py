...
NEW = {
 ...
 # ---------------- B1 AppSec ----------------
 "B1.2": {"goal": "Beat context stuffing with tool-mediated retrieval.",
 ...
 "B1.4": {"goal": "Chart honestly what only SAST found, and what only DAST found.",
  "run": ["cd labs/b1-appsec",
 ...
 "B1.4": {"goal": "Find live secrets in your own agent's footprint.",
 ...
 "B1.5": {"goal": "Publish the four numbers that let a review workflow earn its next rung.",
  "run": ["cd labs/b1-appsec",
