...
NEW = {
 ...
 # ---------------- B2 Harness ----------------
 "D2.5": {"goal": "Refactor a shell tool into three narrow, structured tools.",
 ...
 # ---------------- D1 SOC ----------------
 "D3.6": {"goal": "Show a context-loaded triage loop beating a generic one.",
  "run": ["cd labs/d1-soc",
 ...
 "D2.1": {"goal": "Generate, unit-test and tune detections inside CI.",
 ...
 "D1.2": {"goal": "Get agent telemetry into the SIEM and query it.",
  "run": ["cd labs/d1-soc",
 ...
 "D1.3": {"goal": "Catch a detection silently degrading after a model change.",
  "run": ["cd labs/d1-soc",
 ...
 "D1.1": {"goal": "Build a synthesis loop that must cite or abstain.",
 ...
 # ---------------- D2 IR ----------------
 "D3.5": {"goal": "Pre-load the agent so it reasons as a partner, not a tool you reach for late.",
  "run": ["cd labs/d2-ir",
 ...
 "D3.8": {"goal": "Scope an incident where the initiating agent is not the acting one.",
  "run": ["cd labs/d2-ir",
 ...
 "D5.4": {"goal": "Pick the right layer to change after an incident.",
 ...
 "D4.4": {"goal": "Time your stop authority end to end.",
  "run": ["cd labs/d2-ir",
 ...
 "D5.6": {"goal": "Run the first-hour regulatory checklist.",
  "run": ["cd labs/d2-ir",
