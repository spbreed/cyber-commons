...
NEW = {
 ...
 # ---------------- B2 Harness ----------------
 "D2.6": {"goal": "Refactor a shell tool into three narrow, structured tools.",
 ...
 "D2.4": {"goal": "Generate, unit-test and tune detections inside CI.",
 ...
 "D1.3": {"goal": "Get agent telemetry into the SIEM and query it.",
  "run": ["cd labs/d1-soc",
 ...
 "D1.2": {"goal": "Catch a detection silently degrading after a model change.",
  "run": ["cd labs/d1-soc",
 ...
 "D3.9": {"goal": "Build a synthesis loop that must cite or abstain.",
