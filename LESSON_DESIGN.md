...
Every one of the 137 lessons has the same shape. Not for tidiness — each rule
...
reader to hold 137 different systems, none of which is theirs. One system, named
...
lesson bodies, because keeping all 137 of each in one file is the only way to
...
adding a section to the template never means editing 137 exercise files.
