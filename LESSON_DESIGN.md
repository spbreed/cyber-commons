...
Every one of the 132 lessons has the same shape. Not for tidiness — each rule
...
reader to hold 132 different systems, none of which is theirs. One system, named
...
lesson bodies, because keeping all 132 of each in one file is the only way to
...
adding a section to the template never means editing 132 exercise files.
