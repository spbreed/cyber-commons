...
**130 lessons across 12 chapters.** Every lesson is a self-contained Python
...
| **C · Red Teaming and Security Research with AI** | [6](curriculum/track-c1.md) Red teaming with AI · [7](curriculum/track-c2.md) Security research with AI | 13 |
...
one is caught in nine seconds instead of after 130 remote pushes.
...
CI re-runs all of it with `--check` — secret scan, 130 notebooks, determinism
...
```
site/data/curriculum.json   source of truth: 130 sessions, 12 chapters
...
labs/notebooks/             130 generated notebooks + execution and Kaggle evidence
