...
**118 lessons across 12 chapters.** Most are reading lessons — the idea, the
...
1. Open [**A0.1**](https://spbreed.github.io/cyber-commons/lessons/A0.1.html)
   — how a lesson runs — then [**A1.0**](https://spbreed.github.io/cyber-commons/lessons/A1.0.html).
...
| [`commons/`](skills/commons) | 1 — the mechanism itself: load a skill with the shared runtime and check it against its own contract ([A0.1](labs/notebooks/A0.1.ipynb)) |
...
Five functions, twelve chapters — the first is one lesson on the mechanism
the other eleven use. **Each function opens with an introduction
...
|---|---|---|---|
| **A · Securing AI Architectures** | what can go wrong here, and what closes it | [0](curriculum/track-a0.md) How this commons runs · [1](curriculum/track-a1.md) CyberTravels' architecture and every risk it carries · [2](curriculum/track-a2.md) Identity and ingress · [3](curriculum/track-a3.md) Runtime and the gateway | 38 |
...
> **Spine:** A0.1 → A1.0 → A1.1 → A1.2 → A1.5 → **A1.10** → **A1.12** → A2.1 → A2.3 →
> A2.4 → A3.1 → A3.2 → A3.5 → **B2.0** → B2.2 → B2.3 → **D1.0** →
> D1.5 → **E1.0** → E1.10
...
skills/                     115 agent skills, plus _runtime/ — the one shared library
