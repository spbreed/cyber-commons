...
CONDITIONS = [
 ...
 ("act chain on every refund",
  "attribution survives an incident (E3.5)", "platform-sec", "AC-1/EV-1", "2026-09-15"),
 ...
 ("re-tier automatically if the tool list changes",
  "B1.1 manifest diff wired into CI", "platform-sec", "DR-1", "2026-10-31"),
]
# ------------------------------------------------------------------------ run
...
FIXTURE = {"SCOPE_WEIGHT": SCOPE_WEIGHT, "REQUEST": REQUEST, "TIER_PTS": TIER_PTS, "CONDITIONS": CONDITIONS}
