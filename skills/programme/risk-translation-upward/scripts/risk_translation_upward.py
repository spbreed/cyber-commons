...
FIXTURE = {"SCOPE_WEIGHT": SCOPE_WEIGHT, "FLEET": FLEET, "GATED": GATED, "ATTACKS": ATTACKS, "REQUIRED": REQUIRED, "EVIDENCED": EVIDENCED, "FINDINGS_UPDATE": FINDINGS_UPDATE, "JARGON": JARGON}
