...
OWNED_BY_LESSON = {
 "R1": ["B2.3", "B2.4", "B3.1"], "R2": ["B3.5", "B3.6", "B3.9"],
 "R3": ["B1.2", "B1.3", "B2.6", "B3.1"], "R4": ["C2.5", "B3.8", "C2.18"],
 "R5": ["B2.1", "B2.2", "B2.4"], "R6": ["B3.2", "B1.8", "C2.17"],
 "R7": ["C2.17", "C2.9", "B3.6"], "R8": ["C2.5", "C2.9", "C2.15"],
 "R9": ["B3.3", "B3.7", "E3.7"], "R10": ["E1.3", "F2.5", "B2.7"],
 "R11": ["B2.1", "B2.7", "B1.14"], "R12": ["B1.3", "B1.4", "F1.3"],
}
# ------------------------------------------------------------------------ run
...
FIXTURE = {"FAMILIES": FAMILIES, "COMPONENT": COMPONENT, "AGENT_OF": AGENT_OF, "OWNED_BY_LESSON": OWNED_BY_LESSON}
