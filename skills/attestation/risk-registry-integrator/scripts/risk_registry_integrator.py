...
OWNED_BY_LESSON = {
 ...
 "R3": ["A1.2", "A1.3", "A2.6", "A3.1"], "R4": ["C2.5", "A3.8", "B2.18"],
 "R5": ["A2.1", "A2.2", "A2.4"], "R6": ["A3.2", "A1.8", "B2.17"],
 "R7": ["B2.17", "B2.9", "A3.6"], "R8": ["B2.5", "B2.9", "B2.15"],
 "R9": ["A3.3", "A3.7", "D3.7"], "R10": ["D1.3", "E2.5", "A2.7"],
