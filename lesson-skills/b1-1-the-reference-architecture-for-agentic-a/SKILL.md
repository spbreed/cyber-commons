---
name: b1-1-the-reference-architecture-for-agentic-a
description: >-
...
The learner wants to do lesson **B1.1**: they typed `/b1-1-the-reference-architecture-for-agentic-a`, picked it from
