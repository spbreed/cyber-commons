---
name: a2-4-what-you-have-built
description: >-
  A2.4 — What you have built. Do this lesson: explains the idea in plain words, gets the CyberTravels code as it stood at the end of A2.4, runs it, and reports what happened. Use when working through lesson A2.4 or when asked to do A2.4.
license: Apache-2.0
...
The learner wants to do lesson **A2.4**: they typed `/a2-4-what-you-have-built`, picked it from
...
3. **The audit.**
   - The audit, `skills/architecture/blast-radius-review`, **asks you a question**. You are the model. The harness prints the audit's task; answer it yourself, following the audit skill's procedure, with one JSON object written to `work/answer.json`, then run `PY scripts/lesson.py A2.4 --answer work/answer.json`.
