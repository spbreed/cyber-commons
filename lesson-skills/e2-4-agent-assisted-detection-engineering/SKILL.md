---
name: e2-4-agent-assisted-detection-engineering
description: >-
  E2.4 — Agent-assisted detection engineering. Do this lesson: explains the idea in plain words, gets the CyberTravels code as it stood at the end of E2.4, runs it, and reports what happened. Use when working through lesson E2.4 or when asked to do E2.4.
license: Apache-2.0
...
The learner wants to do lesson **E2.4**: they typed `/e2-4-agent-assisted-detection-engineering`, picked it from
their agent's skill list, or asked to "do E2.4". One skill is one lesson, and
...
2. **Run the lesson.** From the repository root:
   `PY scripts/lesson.py E2.4`. It gets the CyberTravels code as it stood at
   the end of E2.4 into `work/cybertravels`, shows what this lesson added,
