...
|---|---|---|---|
| [A0](track-a0.md) | Running the Commons — GitHub, Kaggle, and What You Need First | 2 | A — Securing AI Architectures |
...
| [D1](track-d1.md) | The Agentic SOC — Discover | 6 | D — The Agentic SOC |
| [D2](track-d2.md) | The Agentic SOC — Detect | 5 | D — The Agentic SOC |
| [D3](track-d3.md) | The Agentic SOC — Investigate | 8 | D — The Agentic SOC |
| [D4](track-d4.md) | The Agentic SOC — Respond | 5 | D — The Agentic SOC |
| [D5](track-d5.md) | The Agentic SOC — Recover and Root Cause | 6 | D — The Agentic SOC |
...
|---|---|---|---|
| **Practitioner** | Analyst, Engineer I–II | Operate loops others built. Recognise failure modes. Escalate correctly. Produce evidence. | Run the lab, explain what the trace shows |
| **Engineer** | Senior Engineer, Lead | Build the harness, the control, the detection, the eval. Own a component end to end. | Ship the deliverable to production |
