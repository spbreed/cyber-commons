...
One Python notebook per curriculum session — **133 of them**, generated from the
...
python3 scripts/run_notebooks.py              # all 133, writes _results.json
```
...
```bash
python3 scripts/build_notebooks.py   # regenerate all 133
