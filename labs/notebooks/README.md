...
One Python notebook per curriculum session — **127 of them**, generated from the
...
python3 scripts/run_notebooks.py              # all 127, writes _results.json
```
...
```bash
python3 scripts/build_notebooks.py   # regenerate all 127
