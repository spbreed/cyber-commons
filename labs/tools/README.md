...
| [`semgrep-sast/`](semgrep-sast) | Semgrep 1.176.0 | [B1.5](../notebooks/B1.5.ipynb) — deterministic SAST, and what it misses | python3 |
| [`openapi-audit/`](openapi-audit) | openapi-spec-validator | [B1.3](../notebooks/B1.3.ipynb) — the threat model's static inputs | python3 |
